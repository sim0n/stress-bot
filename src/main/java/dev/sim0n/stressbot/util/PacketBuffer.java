...
public class PacketBuffer extends ByteBuf {
    ...
    public PacketBuffer(ChannelHandlerContext ctx)
    {
        this(ctx.alloc().buffer());
    }
    ...
    public int[] readVarIntArray(int localvar_readVarIntArray_0) {
        int localvar_readVarIntArray_1 = this.readVarIntFromBuffer();
        if (localvar_readVarIntArray_1 > localvar_readVarIntArray_0) {
            throw new DecoderException("VarIntArray with size " + localvar_readVarIntArray_1 + " is bigger than allowed " + localvar_readVarIntArray_0);
        } else {
            int[] localvar_readVarIntArray_2 = new int[localvar_readVarIntArray_1];

            for(int localvar_readVarIntArray_3 = 0; localvar_readVarIntArray_3 < localvar_readVarIntArray_2.length; ++localvar_readVarIntArray_3) {
                localvar_readVarIntArray_2[localvar_readVarIntArray_3] = this.readVarIntFromBuffer();
            }

            return localvar_readVarIntArray_2;
        }
    }
